...
<div id="main_container">
    ...
    %>
    <div class="right_header">Welcome <%=user %> | <a href="#" class="messages">(3) Messages</a> | <a href="#" class="logout">Logout</a></div>
    ...
    <div class="main_content">
                    ...
                    <div class="menu">
                    <ul>
                    <li><a class="current" href="admin.jsp">Tableau de Bord</a></li>
                    <li><a href="list.html">Gestion Client<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a href="" title="">Ajouter Client</a></li>
                        <li><a href="" title="">Modifier Client</a></li>
                        
                        </ul>
                    <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                    </li>
                    <li><a href="login.html">Gestion Facture<!--[if IE 7]><!--></a><!--<![endif]-->
                   
                    <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                    </li>
                    <li><a href="login.html">Gestion Commande<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a href="" title="">Ajouter Commande</a></li>
                        <li><a href="" title="">Modifer Commande</a></li>
    ...
    <div class="left_content">
            ...
            <div class="sidebarmenu">
                ...
                <a class="menuitem submenuheader" href="">Gestion Clients</a>
                <div class="submenu">
                    <ul>
                ...
                <a class="menuitem submenuheader" href="" >Gestion Facture</a>
                <div class="submenu">
                    <ul>
                ...
                <a class="menuitem submenuheader" href="">Gestion Commande</a>
                <div class="submenu">
                    <ul>
